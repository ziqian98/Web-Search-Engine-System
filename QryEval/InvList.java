...
public class InvList {
  ...
  public class DocPosting {
    ...
    public DocPosting(int d, int... locations) {  //locations is an array. It accepts several ints at the same time
      this.docid = d;
  ...
  public boolean appendPosting (int docid, List<Integer> positions) {
    ...
    DocPosting newPosting = new DocPosting (docid, positions);

    this.postings.add (newPosting);
    this.df ++;
    this.ctf += newPosting.tf;
    return true;
  }
