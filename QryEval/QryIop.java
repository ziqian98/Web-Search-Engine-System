...
public abstract class QryIop extends Qry {
  ...
  public void docIteratorAdvancePast (int docid) {
    ...
    while ((this.docIteratorIndex < this.invertedList.df) &&
           (this.invertedList.getDocid (this.docIteratorIndex) <= docid)) {  //Behind docid on position
  ...
  public void docIteratorAdvanceTo (int docid) {
    ...
    while ((this.docIteratorIndex < this.invertedList.df) &&
           (this.invertedList.getDocid (this.docIteratorIndex) < docid)) {  //Right to docid position
      this.docIteratorIndex ++;
    }
  ...
  public int docIteratorGetMatch () {
    return this.invertedList.getDocid (this.docIteratorIndex);  //use index to get real docid
  }
   ...
   */
  //if Index<df, which means there are still some docs in the term inverted list , we can find
  //at least a document. For first match, index is zero, we get the first doc.
